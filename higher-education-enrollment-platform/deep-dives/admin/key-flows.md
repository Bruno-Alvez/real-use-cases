...
6. Database trigger populates nome_aluno from students table based on CPF (`postgres_schema_vouchers_campaigns_final.sql` line 384-388)
...
- `database/postgres/postgres_schema_vouchers_campaigns_final.sql` lines 384-388
...
8. Database trigger updates campaign.utilizados count on campaign_usage changes (`postgres_schema_vouchers_campaigns_final.sql` lines 320-340)
...
- `database/postgres/postgres_schema_vouchers_campaigns_final.sql` lines 144-157 (campaign_shifts CHECK constraint)
...
**Evidence:**
- `database/postgres/postgres_schema_vouchers_campaigns_final.sql` lines 602-644
...
**Evidence:**
- `database/postgres/postgres_cron_daily_updates.sql` - Full script
...
2. Frontend calls `updateCampaign` service (`frontend/src/services/postgres/campaigns.ts`)
...
- `frontend/src/services/postgres/campaigns.ts` - Service with shift mapping
