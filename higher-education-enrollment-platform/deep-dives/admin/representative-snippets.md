...
**Context:** Handles PostgreSQL-specific error codes (PGRST116 = not found) and maps database records to domain objects.
...
**File:** `database/postgres/postgres_schema_vouchers_campaigns_final.sql`
