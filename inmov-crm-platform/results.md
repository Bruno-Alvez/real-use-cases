...
Lívia qualifies leads 24/7 via WhatsApp. Collects structured data, classifies temperature before human contact.
...
- Session uptime: 95.2% for consultant session, 93.6% for Lívia session (includes planned restarts)
