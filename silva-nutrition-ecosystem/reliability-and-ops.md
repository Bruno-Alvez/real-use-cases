...
**Credential rotation:** Bling OAuth2 tokens are refreshed automatically by the Lambda layer on expiry. Supabase and WooCommerce credentials are static but stored in Secrets Manager with IAM-scoped access. Rotation requires a Secrets Manager update; no Lambda redeployment needed.
