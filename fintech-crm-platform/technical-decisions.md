...
Separate Baileys instances for consultants and AI agent. Decision driven by:
...
// AI agent session
const aiBaileysService = AIBaileysService.getInstance();
await aiBaileysService.initialize(); // Uses ./baileys_sessions/ai-agent
```
